...
const SecondaryButton = styled(Button)`
  ...
  color: ${props => props.theme?.primary || '#3C8C3C'};
  border: 1px solid ${props => props.theme?.primary || '#3C8C3C'};
...
const CertificationView = ({ certifications }) => {
  ...
  const handleDownloadCertificate = (pdfPath, fileName) => {
      ...
      {certifications.map((cert, index) => (
        <CertificationCard key={index}>
          ...
          <ActionButtons>
            ...
            <SecondaryButton
              onClick={() => handleDownloadCertificate(cert.pdfPath, cert.fileName || 'certificate.pdf')}
            >
              Download
            </SecondaryButton>
          </ActionButtons>
