 ...
 * @returns {Promise<any>}
 */
export const saveEntityData = async (entityName, details, isProtected = true, instanceId = null) => {
  const path = instanceId? `/entity/${entityName}/${instanceId}`: `/entity/save/`;
  let requestBody = {
  ...
  return makeApiRequest(path, instanceId? "PATCH":"POST", requestBody, headers);
};
